...
import (
	...
	"golang-microservices-gRPC/src/services/blog/gen/restapi/operations"
)

//go:generate swagger generate server --target ..\..\gen --name GreetingServer --spec ..\..\swagger.yaml --exclude-main
